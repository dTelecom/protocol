...
type EgressInternalClient interface {
	StartEgress(context.Context, string, ...psrpc.RequestOption) (psrpc.ClientStream[*StartEgressRequest, *livekit1.EgressInfo], error)
...
type EgressInternalServerImpl interface {
	StartEgress(psrpc.ServerStream[*livekit1.EgressInfo, *StartEgressRequest]) error
...
func NewEgressInternalClient(clientID string, bus psrpc.MessageBus, opts ...psrpc.ClientOption) (EgressInternalClient, error) {
	rpcClient, err := psrpc.NewRPCClientWithStreams("EgressInternal", clientID, bus, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *egressInternalClient) StartEgress(ctx context.Context, topic string, opts ...psrpc.RequestOption) (psrpc.ClientStream[*StartEgressRequest, *livekit1.EgressInfo], error) {
	return psrpc.OpenStream[*StartEgressRequest, *livekit1.EgressInfo](ctx, c.client, "StartEgress", topic, opts...)
}
...
func (s *egressInternalServer) RegisterStartEgressTopic(topic string) error {
	return psrpc.RegisterStreamHandler(s.rpc, "StartEgress", topic, s.svc.StartEgress, nil)
}
...
type EgressHandlerClient interface {
	UpdateStream(context.Context, string, *livekit1.UpdateStreamRequest, ...psrpc.RequestOption) (*livekit1.EgressInfo, error)

	StopEgress(context.Context, string, *livekit1.StopEgressRequest, ...psrpc.RequestOption) (*livekit1.EgressInfo, error)
}
...
func (c *egressHandlerClient) UpdateStream(ctx context.Context, topic string, req *livekit1.UpdateStreamRequest, opts ...psrpc.RequestOption) (*livekit1.EgressInfo, error) {
	return psrpc.RequestSingle[*livekit1.EgressInfo](ctx, c.client, "UpdateStream", topic, req, opts...)
}
...
func (c *egressHandlerClient) StopEgress(ctx context.Context, topic string, req *livekit1.StopEgressRequest, opts ...psrpc.RequestOption) (*livekit1.EgressInfo, error) {
	return psrpc.RequestSingle[*livekit1.EgressInfo](ctx, c.client, "StopEgress", topic, req, opts...)
}
